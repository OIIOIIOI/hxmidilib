...
class MetaEventMessageType {
	...
	public static var SEQUENCE_NUM:Int =		0x00;
	
	public static var TEXT:Int =				0x01;
	public static var COPYRIGHT:Int =			0x02;
	public static var TRACK_NAME:Int =			0x03;
	public static var INSTRUMENT_NAME:Int =		0x04;
	public static var LYRIC:Int =				0x05;
	public static var MARKER:Int =				0x06;
	public static var CUE_POINT:Int =			0x07;
	public static var PROGRAM_NAME:Int =		0x08;
	public static var DEVICE_NAME:Int =			0x09;
	
	public static var CHANNEL_PREFIX:Int =		0x20;
	public static var MIDI_PORT:Int =			0x21;
	public static var END_OF_TRACK:Int =		0x2F;
	public static var SET_TEMPO:Int =			0x51;
	public static var SMPTE_OFFSET:Int =		0x54;
	public static var TIME_SIGNATURE:Int =		0x58;
	public static var KEY_SIGNATURE:Int =		0x59;
	public static var SEQUENCER_SPECIFIC:Int =	0x7F;
